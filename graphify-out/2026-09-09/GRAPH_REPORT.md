...
- [[_COMMUNITY_useShowStore|useShowStore]]
...
Cohesion: 0.09
Nodes (40): Tab, AIPanelProps, AudioPanel(), AudioPanelProps, CastPanel(), CastPanelProps, dragHandleStyle, deleteButtonStyle (+32 more)

### Community 1 - "AI Formation Generation Logic"
Cohesion: 0.09
Nodes (22): AudioSegmentBarProps, FormationBar(), FormationBarProps, hungarian(), ArrayPatchEntry, AudioSegment, Formation, HistoryEntry (+14 more)

### Community 2 - "Dashboard & App Shell"
Cohesion: 0.13
Nodes (27): Dashboard(), DashboardProps, ProjectCard(), ProjectCardProps, SelectedView, SidebarItemProps, FolderMember, InviteModalProps (+19 more)
...
Cohesion: 0.13
Nodes (19): client, extractJsonArray(), GenerateRequest, getAuthToken(), getUsageCount(), handler(), PerformerInput, PositionInput (+11 more)

### Community 18 - "FormationMetrics.tsx"
Cohesion: 0.11
Nodes (28): AIPanel(), describeBalance(), FormationMetrics(), MetricRow(), MetricStatus, statusIcon(), AIGeneratedPosition, AIGenerationOptions (+20 more)

### Community 20 - "useShowStore"
Cohesion: 0.12
Nodes (22): App(), useWindowSize(), ContextMenu, FormationTimeline(), SegmentRow(), NavPanel, PropertyPanel(), AudioSegmentBar() (+14 more)

## Knowledge Gaps
- **159 isolated node(s):** `PerformerInput`, `PositionInput`, `GenerateRequest`, `PositionOutput`, `client` (+154 more)
...
- **Why does `Dashboard()` connect `Dashboard & App Shell` to `AI Generation Serverless Function`, `useShowStore`, `Core Dependencies`?**
